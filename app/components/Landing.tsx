      ...
      <section id="developers" className="py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20 space-y-6">
            <div className="flex items-center justify-center gap-4 text-zinc-600">
              <div className="h-px w-8 bg-current" />
              <span className="text-[10px] font-black uppercase tracking-[0.5em]">For Builders</span>
              <div className="h-px w-8 bg-current" />
            </div>
            <h2 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tighter">Built for Developers</h2>
            <p className="text-xl text-zinc-500 font-light max-w-2xl mx-auto leading-relaxed">
              Open source infrastructure for the Starknet ecosystem
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <h3 className="text-3xl font-black text-white uppercase tracking-tighter">Integrate Reflecter Wallet</h3>
                <p className="text-zinc-500 font-light leading-relaxed">
                  Build on top of our open source infrastructure. Access our APIs for wallet integration, account abstraction, and social recovery.
                </p>
              </div>
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-4 border border-white/10 bg-white/5">
                  <Github size={16} className="text-white" />
                  <span className="text-sm font-bold text-white">Open source repository on GitHub</span>
                  <ChevronRight size={14} className="ml-auto text-zinc-500" />
                </div>
                <div className="flex items-center gap-3 p-4 border border-white/10 bg-white/5">
                  <FileText size={16} className="text-white" />
                  <span className="text-sm font-bold text-white">API documentation for wallet integration</span>
                  <ChevronRight size={14} className="ml-auto text-zinc-500" />
                </div>
                <div className="flex items-center gap-3 p-4 border border-white/10 bg-white/5">
                  <Shield size={16} className="text-white" />
                  <span className="text-sm font-bold text-white">Account Abstraction with social recovery</span>
                  <ChevronRight size={14} className="ml-auto text-zinc-500" />
                </div>
                <div className="flex items-center gap-3 p-4 border border-white/10 bg-white/5">
                  <Terminal size={16} className="text-white" />
                  <span className="text-sm font-bold text-white">Built with Cairo & Starknet.js</span>
                  <ChevronRight size={14} className="ml-auto text-zinc-500" />
                </div>
              </div>
              <button className="px-8 py-4 bg-transparent border border-white/10 text-white font-black uppercase tracking-widest text-[10px] hover:bg-white/5 transition-all w-full">
                View Documentation
              </button>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative border border-white/10 bg-black p-8 shadow-2xl">
                <div className="space-y-6">
                  ...
                  <div className="font-mono text-sm text-zinc-400 space-y-4">
                    <div className="text-emerald-500/80">// Integrate Reflecter Wallet API</div>
                    <div className="space-y-1">
                      <div>const wallet = await reflecterWallet.connect(&#123;</div>
                      <div className="pl-6 text-blue-400/80">provider: <span className="text-zinc-300">"social-login"</span>,</div>
                      <div className="pl-6 text-blue-400/80">network: <span className="text-zinc-300">"starknet-mainnet"</span>,</div>
                      <div className="pl-6 text-blue-400/80">features: <span className="text-zinc-300">["swap", "lending", "trading"]</span></div>
                      <div>&#125;);</div>
                    </div>
                    <div className="text-zinc-600 italic">// Start building on Starknet...</div>
                  </div>
                </div>
              </div>
            </div>
